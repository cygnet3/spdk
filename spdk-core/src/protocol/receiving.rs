//! Silent payment scanning and output detection for receiving.
//!
//! ## Overview
//!
//! The [`Receiver`] struct provides silent payment scanning functionality.
//! It does not store private keys directly, maintaining security by only keeping
//! the scan and spend public keys along with label information.
//!
//! ## Usage
//!
//! 1. Create a [`Receiver`] with your silent payment keys and labels
//! 2. Calculate the ECDH shared secret using [`calculate_ecdh_shared_secret`](crate::protocol::utils::receiving::calculate_ecdh_shared_secret)
//! 3. Call [`scan_transaction`](Receiver::scan_transaction) to detect owned outputs
//!
//! The receiver will identify outputs belonging to you, including labeled outputs,
//! and return the necessary tweaks for spending.
use std::{
