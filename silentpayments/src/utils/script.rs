...
/// This is supposed to help as a kind of quick sanity check, but the real check must be done by the
/// caller that have access to bitcoin crate and more context.
